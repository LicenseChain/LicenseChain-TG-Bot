...
└────────────────────────────────┬─────────────────────────────────────────┘
                    ...
                    - tg_bot_users, tg_bot_tickets, tg_bot_commands, ...
                                 │
┌────────────────────────────────┴───────────────────────────────────────┐
│  LicenseChain API (https://api.licensechain.app/v1 or self‑hosted)     │
...
The bot uses:
- `LICENSECHAIN_API_KEY` – Bearer token for the API (legacy `LICENSE_CHAIN_API_KEY` also works).
- `LICENSECHAIN_BASE_URL` – e.g. `https://api.licensechain.app/v1` (legacy `LICENSE_CHAIN_API_URL` also works).
